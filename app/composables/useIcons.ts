...
export const icons = {
  ...
  // seta de encaminhar — no balão e no selo "Encaminhada"
  forward:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 5l7 7-7 7"/><path d="M20 12H8a4 4 0 0 0-4 4v3"/></svg>',
  // seta de voltar — usada no header do chat no mobile
  arrowLeft:
